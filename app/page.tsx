...
export default function Home() {
  ...
  const cards = [
    ...
    },
    {
      ...
      bgColor: "bg-blue-200",
      tasks: [
        { task: "Share artwork on Instagram", reward: "+25 artist points" },
        { task: "Attend virtual art workshop", reward: "+100 artist points" },
        { task: "Submit fan art for review", reward: "+250 artist points" }
      ],
      rewards: [
        { 
